...
add5 = ct.CTkButton(frame1, text="Найти обратную", command=partial(inver, catrix1), width=170,height=10)
add5.grid(row = 5, column = 1, columnspan = 2)

add6 = ct.CTkButton(frame1, text="Транспонировать", command=partial(tran, catrix1, matrix1, True), width=170,height=10,)
add6.grid(row = 4, column = 1, columnspan = 2)

add7 = ct.CTkButton(frame2, text="Найти обратную", command=partial(inver, catrix2), width=170,height=10)
add7.grid(row = 5, column = 1, columnspan = 2)

add8 = ct.CTkButton(frame2, text="Транспонировать", command=partial(tran, catrix2, matrix2, False), width=170,height=10)
